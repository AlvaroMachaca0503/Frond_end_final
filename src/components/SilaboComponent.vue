<template>
  <div class="general-component">
    ...
    <!-- Modal tipo overlay para formulario de sílabo -->
                ...
                <div class="unidad-content" v-show="!colapsadasUnidades.includes(idx)">
                  ...
                  <div class="form-group">
                    <div style="display: flex; justify-content: center; align-items: center; position: relative; margin-bottom: 8px;">
                      <span style="font-weight: 600; font-size: 1rem; text-align: center; flex: 1;">Semanas y contenidos específicos</span>
                      <button type="button" class="btn btn-primary btn-sm" @click="addSemana(idx)" style="position: absolute; right: 0;">Añadir semana</button>
                    </div>
                    <div v-for="(sem, sidx) in unidad.semanas" :key="sidx" class="semana-item" style="display: flex; gap: 8px; align-items: flex-start; margin-bottom: 8px;">
                      ...
                      <textarea v-model="sem.contenido" class="form-textarea" rows="2" placeholder="Contenidos específicos..." style="flex:1;"></textarea>
